...
<%
    ...
    if (userID == null) {
        ...
        try {
            ...
            String sql = "select * from reserve where customerIdentifier=? and restaurantCode=? and reservedTime=STR_TO_DATE(?, '%Y-%m-%d %H:%i:%s')";
            ...
            if (rs.next())
                ...
                sql = "insert into reserve values(?, ?, STR_TO_DATE(?, '%Y-%m-%d %H:%i:%s'), ?);";
